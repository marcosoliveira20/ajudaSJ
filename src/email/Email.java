...
public class Email {
	private static String email = "exemplo.exemplo@gmail.com";
	private static String senha = "exemplo";
	...
	public static void linkParaTrocaDeSenha(String emailConfirma, String url) {
		Properties props = new Properties();
		/** Parâmetros de conexão com servidor Gmail */
		props.put("mail.smtp.host", "smtp.gmail.com");
		props.put("mail.smtp.socketFactory.port", "465");
		...
		try {
			...
			message.setText("Olá,aqui está o link para a troca de sua senha: \n"+ url+". \n  \n \n Att. Equipe Ajuda São judas" );
			/** Método para enviar a mensagem criada */
			Transport.send(message);
