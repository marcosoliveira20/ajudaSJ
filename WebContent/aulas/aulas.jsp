					...
					<ul class="list-group">
						...
						for (int i = 0; i < solici.size(); i++) {
							...
							if (solici.get(i).getStatus().equalsIgnoreCase("aceita")) {
								...
								+ "	                       <span><strong>Horário: </strong>" + solici.get(i).getHoraInicio() + " "
								+ "até " + solici.get(i).getHoraFinal() + "   </span>\r\n"
				...
				<div class="prof-lista">
					<ul class="list-group">
						...
						<c:forEach var="solicitacao" items="${solicitacoes}">
							<a href='detalhes.solicitacao.jsp?id= ${solicitacao.id}'>
								<li class="list-group-item">
									<div>
										<div class=\media-bodytext-dark\>  
