...
<body>
	...
	<section>
		<div class="container pt-5">
			<!--Container -->
			<h1 class="mb-3 text-md-center text-danger bg-light">
				<%
			...
			if (usuarioLogado.getAdm().equals("s")) {
				out.print("<a href='adm.noticias.jsp?id=" + noticia.getId()
				+ "'> <input type='submit' value='Atualiza' class='btn btn-warning mt-2'></a>");

				out.print("<a href='ApagarNoticia.do?id=" + noticia.getId()
				+ "'> <input type='submit' value='Excluir' class='btn btn-danger mt-2'></a>");
			}
			%>
		</div>
		<!--/Container-->
