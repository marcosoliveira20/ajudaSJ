      ...
      <nav class="navbar navbar-expand-md navbar-light bg-light border-bottom">
        <div class="container">
          <a href="principal.html" class="navbar-brand">
            <img src="img/logoteste2.png" width="142" height="70">
          </a>
        ...
        <div class="row">
          <div class="col-md-4 offset-md-4">
             <div class="card text-center">
              <div class="card-body">
                <h4 class="card-title"><i class="fas fa-lock display-1"></i></h4>
                
                <p class="card-text pt-2 text-black-50">Digite o e-mail de criação da conta que iremos enviar um link para ajudar você a acessar sua conta.</p>
                <form method="post" action="EsqueciASenha.do">
                  <div class="form-group">
                    <input type="text" id="email" name="email" placeholder="E-mail de usuário" class="form-control">
                  </div>
                <Input type="submit" value="Enviar" name="acao" class="btn btn-primary btn-block">
                </form>
